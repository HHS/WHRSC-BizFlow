...
--------------------------------------------------------
  ...
  --ALTER TABLE HHS_HR.LIST_SEARCH_CANDIDATE MODIFY (CANDIDATE_ID NOT NULL ENABLE);
 
  --ALTER TABLE HHS_HR.LIST_SEARCH_CANDIDATE MODIFY (LIST_ID NOT NULL ENABLE);
...
END;
/
ALTER TRIGGER HHS_HR.LIST_SEARCH_CANDIDATE_TRG ENABLE;
...
END;
/
ALTER TRIGGER HHS_HR.ATTACHMENT_TRG ENABLE;
...
END;
/
ALTER TRIGGER HHS_HR.HHS_LIST_MANAGER_LOOKUP_TRG ENABLE;
