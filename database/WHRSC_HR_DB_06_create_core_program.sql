...
BEGIN
    ...
    */
    ...
    V_RLVNTDATANAME := 'proposedEffDate';
        ...
        V_RLVNTDATANAME := 'proposedEffDateStr';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/proposedEffDateStr/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
	...
	V_RLVNTDATANAME := 'hhsidMatch';
            V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/hhsidMatch/text()');
            IF V_XMLVALUE IS NOT NULL THEN
                  V_VALUE := V_XMLVALUE.GETSTRINGVAL();
            ELSE
                  V_VALUE := NULL;
...
create or replace PROCEDURE SP_UPDATE_RECRUITMENT_PROCESS
 ...
 , I_FIELD_DATA      IN      XMLTYPE
	...
	BEGIN
		...
		, X.CAN_NO     
            ...
            , X.SUBMITTED_PCKG_QLTY_COMMENTS
         	 FROM TBL_FORM_DTL FD  
                ...
                ,DATE_RECRUITMENT_AUTHORIZED		DATE  PATH 'PRERECRUITMENT/DATE_RECRUITMENT_AUTHORIZED'
         ...
         , TRG.ADMIN_CODE = SRC.ADMIN_CODE
          ...
          ,TRG.DATE_RECRUITMENT_AUTHORIZED = SRC.DATE_RECRUITMENT_AUTHORIZED
          ...
          WHEN NOT MATCHED THEN INSERT
              (
               ...
               , TRG.ADMIN_CODE
                ...
                ,TRG.COMMENTS_STATUS   
                ,TRG.JOB_OPENING_ID	
                ,TRG.DATE_RECRUITMENT_AUTHORIZED
                ,TRG.CAN_NO
                ,TRG.TK_NO
              ...
              (
               ...
               , SRC.ADMIN_CODE
                ...
                ,SRC.COMMENTS_STATUS   
                ,SRC.JOB_OPENING_ID	
                ,SRC.DATE_RECRUITMENT_AUTHORIZED
                ,SRC.CAN_NO
                ,SRC.TK_NO               
      ...
      BEGIN
	   ...
	   BEGIN
           ...
           ,X.RECRUITMENT_PCKG_QUALITY
           ,X.APPLICANT_LIMIT
           ,X.REC_PCKG_NOTES
	   ,X.SHARED_ANN_REVIEWED
         	 ...
         	 FROM TBL_FORM_DTL FD  
                ...
                --,NUM_POSITIONS_TO_BE_ADV					NUMBER(10)  PATH 'PRERECRUITMENT/NUM_POSITIONS_TO_BE_ADV'
							...
							,INCENTIVES_OFFERED							VARCHAR2(1000) PATH 'PRERECRUITMENT/INCENTIVES_OFFERED'
                                ...
                                ,RECRUITMENT_PCKG_QUALITY					VARCHAR2(20)  PATH 'PRERECRUITMENT/RECRUITMENT_PCKG_QUALITY'
                                ,APPLICANT_LIMIT					        NUMBER(5)  PATH 'PRERECRUITMENT/APPLICANT_LIMIT'
                                ,REC_PCKG_NOTES	
				,SHARED_ANN_REVIEWED							VARCHAR2(1000) PATH 'PRERECRUITMENT/SHARED_ANN_REVIEWED'
						) X
					WHERE X.TRANSACTION_ID = I_TRANSACTIONID
				) SRC ON (SRC.TRANSACTION_ID = TRG.TRANSACTION_ID)
				WHEN MATCHED THEN UPDATE SET
          ...
          ,TRG.LEGISLATIVE_INIT_SUPPORTED = SRC.LEGISLATIVE_INIT_SUPPORTED
                  ...
                  ,TRG.RECRUITMENT_PCKG_QUALITY = SRC.RECRUITMENT_PCKG_QUALITY
                  ,TRG.APPLICANT_LIMIT = SRC.APPLICANT_LIMIT
                  
                  ,TRG.REC_PCKG_NOTES = SRC.REC_PCKG_NOTES
		  ,TRG.SHARED_ANN_REVIEWED = SRC.SHARED_ANN_REVIEWED
        ...
        (
         ...
         ,TRG.DATE_PRERECRUIT_SHEET_SIGNED
          ...
          ,TRG.RECRUITMENT_PCKG_QUALITY
          ,TRG.APPLICANT_LIMIT
          ,TRG.REC_PCKG_NOTES
	  ,TRG.SHARED_ANN_REVIEWED
        ...
        ,SRC.RECRUITMENT_PCKG_QUALITY
        ,SRC.APPLICANT_LIMIT
        ,SRC.REC_PCKG_NOTES
	,SRC.SHARED_ANN_REVIEWED
      )
      ;      
    ...
    SP_UPDATE_MULTI_SELECT(I_TRANSACTIONID, 'RECRUITMENT', 'ADDITIONAL_RECRUIT_CHANNELS', 'RECRUITMENT');
     SP_UPDATE_MULTI_SELECT(I_TRANSACTIONID, 'RECRUITMENT', 'SHARED_ANN_REVIEWED', 'RECRUITMENT');
 ...
 , I_FIELD_DATA      IN      XMLTYPE
	...
	,VIN				VARCHAR2(40) PATH 'APPOINTMENT/A_RELATE_RECR_REQ'
      ...
      BEGIN
	   ...
	   ,X.EXTERNAL_CERT_NUMBER 
	  ,X.CERTIFICATE_DETAILS
	 ,X.EXTERNAL_CERT_ANN_NUMBER 
	 ,X.EXTERNAL_CERT_POS_TITLE	
	 ,X.EXTERNAL_CERT_GRADE	
	FROM TBL_FORM_DTL FD  
						, XMLTABLE('/DOCUMENT'
							PASSING FD.FIELD_DATA
							COLUMNS
		...
		,EXTERNAL_CERT_NUMBER	VARCHAR2(40)    PATH 'APPOINTMENT/EXTERNAL_CERT_NUMBER'
		,CERTIFICATE_DETAILS		VARCHAR2(220)    PATH 'APPOINTMENT/CERTIFICATE_DETAILS'
		,EXTERNAL_CERT_ANN_NUMBER		VARCHAR2(40)    PATH 'APPOINTMENT/EXTERNAL_CERT_ANN_NUMBER'
		,EXTERNAL_CERT_POS_TITLE		VARCHAR2(100)   PATH 'APPOINTMENT/EXTERNAL_CERT_POS_TITLE'
		,EXTERNAL_CERT_GRADE		VARCHAR2(30)    PATH 'APPOINTMENT/EXTERNAL_CERT_GRADE'
						) X
					WHERE X.TRANSACTION_ID = I_TRANSACTIONID
				) SRC ON (SRC.TRANSACTION_ID = TRG.TRANSACTION_ID)
				WHEN MATCHED THEN UPDATE SET
	    ...
	    ,TRG.EXTERNAL_CERT_NUMBER   = SRC.EXTERNAL_CERT_NUMBER
	  ,TRG.CERTIFICATE_DETAILS  = SRC.CERTIFICATE_DETAILS
         ,TRG.EXTERNAL_CERT_ANN_NUMBER  = SRC.EXTERNAL_CERT_ANN_NUMBER
	 ,TRG.EXTERNAL_CERT_POS_TITLE	 = SRC.EXTERNAL_CERT_POS_TITLE
	,TRG.EXTERNAL_CERT_GRADE	 = SRC.EXTERNAL_CERT_GRADE
          WHEN NOT MATCHED THEN INSERT
          (
            TRG.TRANSACTION_ID
	   ...
	   ,TRG.EXTERNAL_CERT_NUMBER 
	   ,TRG.CERTIFICATE_DETAILS
	 ,TRG.EXTERNAL_CERT_ANN_NUMBER 
	 ,TRG.EXTERNAL_CERT_POS_TITLE	
	 ,TRG.EXTERNAL_CERT_GRADE	
          )
          VALUES
          (
            SRC.TRANSACTION_ID
	     ...
	     ,SRC.EXTERNAL_CERT_NUMBER 
  ,SRC.CERTIFICATE_DETAILS
  ,SRC.EXTERNAL_CERT_ANN_NUMBER 
  ,SRC.EXTERNAL_CERT_POS_TITLE	
  ,SRC.EXTERNAL_CERT_GRADE	
