 ...
 *         &lt;element name="eventType" type="{http://hspd12.hhs.gov/federated/enrollment/v1}IdmsEventNotifyType"/&gt;
...
@XmlRootElement(name = "SubscribeIdmsEventsRequest")
public class SubscribeIdmsEventsRequest {
