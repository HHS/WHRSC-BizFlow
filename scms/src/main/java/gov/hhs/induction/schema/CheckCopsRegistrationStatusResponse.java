 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="CopsSerialNumber" type="{http://hspd12.hhs.gov/federated/enrollment/v1}CopsSerialNumberType" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CheckCopsRegistrationStatusResponse")
public class CheckCopsRegistrationStatusResponse {

    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "CopsSerialNumber")
