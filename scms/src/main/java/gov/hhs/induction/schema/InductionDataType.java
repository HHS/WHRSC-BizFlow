 ...
 *         &lt;element name="ComponentCode" type="{http://hspd12.hhs.gov/federated/enrollment/v1}ComponentCodeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InductionDataType {
    ...
    @XmlElementRef(name = "CopsAgency", namespace = "http://hspd12.hhs.gov/federated/enrollment/v1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> copsAgency;
    @XmlElement(name = "ComponentCode")
    @XmlSchemaType(name = "string")
    protected ComponentCodeType componentCode;
     ...
     *     
     */
    public JAXBElement<String> getCopsAgency() {
        return copsAgency;
    }
     ...
     *     
     */
    public void setCopsAgency(JAXBElement<String> value) {
     ...
     * @return
     *     possible object is
     *     {@link ComponentCodeType }
     *     
     */
    public ComponentCodeType getComponentCode() {
     ...
     *     
     */
    public void setComponentCode(ComponentCodeType value) {
