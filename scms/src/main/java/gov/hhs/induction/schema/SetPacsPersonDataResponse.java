 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="RequestedValuesAlreadySet" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "resultCode",
    "requestedValuesAlreadySet",
    "resultMessage",
    "failureDetailMessage"
})
@XmlRootElement(name = "SetPacsPersonDataResponse")
public class SetPacsPersonDataResponse {

    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "RequestedValuesAlreadySet")
    protected Boolean requestedValuesAlreadySet;
    ...
    /**
     * Gets the value of the requestedValuesAlreadySet property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isRequestedValuesAlreadySet() {
        return requestedValuesAlreadySet;
    }

    /**
     * Sets the value of the requestedValuesAlreadySet property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setRequestedValuesAlreadySet(Boolean value) {
        this.requestedValuesAlreadySet = value;
    }
