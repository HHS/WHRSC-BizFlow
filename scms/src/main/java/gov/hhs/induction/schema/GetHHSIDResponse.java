 ...
 *               &lt;enumeration value="NonUnique"/&gt;
 *             &lt;/restriction&gt;
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FailureDetailMessage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Cardholder" type="{http://hspd12.hhs.gov/federated/enrollment/v1}GetHHSIdDataType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetHHSIDResponse")
public class GetHHSIDResponse {
    ...
    protected GetHHSIdDataType cardholder;
     ...
     * @return
     *     possible object is
     *     {@link GetHHSIdDataType }
     *     
     */
    public GetHHSIdDataType getCardholder() {
        return cardholder;
    }
     ...
     *     
     */
    public void setCardholder(GetHHSIdDataType value) {
